...
statTargetGUI <- function() {
    ...
    lyout[3, 2] <- (widgets$stat <- gWidgets2::gedit(text = "", initial.msg = "Click the left button", 
        cont = lyout))
    ...
    gsc <- gWidgets2::gbutton("Run", handler = function(h, ...) {
        ...
        ltxt1 <- gWidgets2::gtext(paste(logtmp1, collapse = "\n"), wrap = FALSE, font.attr = list(style = "monospace", 
            family = "times"), cont = logg1, expand = TRUE, fill = TRUE)
    ...
    gWidgets2::gbutton("Run", handler = function(h, ...) {
        ...
        ltxt <- gtext(paste(logtmp2, collapse = "\n"), wrap = FALSE, font.attr = list(style = "monospace", 
            family = "times", size = "x-small"), cont = logg2, expand = TRUE, fill = TRUE)
