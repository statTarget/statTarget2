...
#' Mass Spectrometry Data softwares, such as XCMS, SIEVE and SKYLINE
...
#' including 'XCMS' or 'xcms','SIEVE' or 'sieve' and 'skyline' or 'SKYLINE'; 
...
transX <- function(data, type) {
    ...
    write.csv(transX$PhenoFile, paste(dirout.uni, "/PhenoFile_", type, ".csv", sep = ""), row.names = FALSE)
