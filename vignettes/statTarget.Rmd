...
experiments of metabolomics and targeted proteomics. statTarget is a streamlined tool 
...
experiments`, and comprehensive statistic analysis in 
 metabolomics and targeted proteomics.
...
A streamlined tool provides graphical user interface for quality control based signal correction, integration of metabolomics and proteomics data from multi-batch experiments, and the comprehensive statistic analysis in non-targeted or targeted metabolomics and targeted proteomics. 
...
Loplot (left): the visible image of quality controls for each features
